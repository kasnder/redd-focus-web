...
const cssSelectors = {
    ...
    // LinkedIn
    linkedinFeedCssOn: '/* needs to be explicitly shown, otherwise not loaded */ div[data-testid="mainFeed"] ._8969c64b.efd98e7a._4e14bf6e,  div.scaffold-finite-scroll.scaffold-finite-scroll--infinite, div.scaffold-finite-scroll.scaffold-finite-scroll--finite, #feed-container, .feed-container, section.feeds, li.feed-item, article.main-feed-activity-card {display: block !important;}',
