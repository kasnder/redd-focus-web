...
const cssSelectors = {
    ...
    youtubeSubscriptionsCssOn: 'ytd-guide-section-renderer:has(a[href="/feed/channels"]), a[href="/feed/subscriptions"] { display: flex !important; } ytm-pivot-bar-renderer[role="tablist"] ytm-pivot-bar-item-renderer:nth-child(3) { display: flex !important; }',
    youtubeSubscriptionsCssOff: 'ytd-guide-section-renderer:has(a[href="/feed/channels"]), a[href="/feed/subscriptions"] { display: none !important; } ytm-pivot-bar-renderer[role="tablist"] ytm-pivot-bar-item-renderer:nth-child(3) { display: none !important; }',
    ...
    youtubeExploreCssOn: '#sections ytd-guide-section-renderer:has(a[href="/gaming"]), #sections ytd-guide-section-renderer:nth-child(2):not(:has(#guide-section-title[is-empty])) { display: block !important; }',
    youtubeExploreCssOff: '#sections ytd-guide-section-renderer:has(a[href="/gaming"]), #sections ytd-guide-section-renderer:nth-child(2):not(:has(#guide-section-title[is-empty])) { display: none !important; }',
