...
const cssSelectors = {
    ...
    youtubeSubscriptionsCssOn: 'ytd-guide-section-renderer:has(a[href="/feed/channels"]), ytd-guide-section-renderer:has(a[href="/feed/subscriptions"]) { display: block !important; } ytm-pivot-bar-renderer[role="tablist"] ytm-pivot-bar-item-renderer:nth-child(3) { display: flex !important; }',
